...
//     useEffect(() => {
//         fetchData(false); // Initial fetch without a startKey
//     }, [courseID]); // Dependency on courseID to refetch if it changes
...
//     const handlePrev = () => {
//         // This assumes you have a way to track and move to the previous start key, which might require additional state logic
//         setStartKey(null); // Resetting to null or adjust according to your API capabilities
//         fetchData(false);
//     };
...
//                 <Button onClick={handlePrev} disabled={!startKey}>Previous</Button>
